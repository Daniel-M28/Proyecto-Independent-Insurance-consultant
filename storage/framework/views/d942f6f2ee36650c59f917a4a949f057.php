  ...
  <div class="flex flex-col lg:flex-row max-w-7xl mx-auto min-h-screen">
    ...
    <div class="w-full lg:w-1/2 p-8 lg:p-16 bg-zinc-800">
      ...
      <p class="text-lg leading-relaxed">
        Proporciona la siguiente información, completa cada campo con los datos solicitados. Nos pondremos en contacto contigo lo antes posible.
      </p>
        <img src="<?php echo e(asset('imgs/factoring.jpg')); ?>" alt="Cotización" class="mt-8 w-full max-w-md mx-auto lg:mx-0 h-auto rounded-lg shadow-md">
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto_iic\resources\views/factoring.blade.php ENDPATH**/ ?>