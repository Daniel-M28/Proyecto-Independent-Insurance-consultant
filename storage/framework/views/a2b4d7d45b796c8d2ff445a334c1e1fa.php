                ...
                <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-zinc-700 divide-x divide-zinc-600">
                        ...
                        <td class="px-6 py-4 max-w-xs truncate" title="<?php echo e($request->observations); ?>">
                            <?php echo e($request->observations ?? '—'); ?>

                        </td>

                        <td class="px-6 py-4">
                            <?php echo e(\Carbon\Carbon::parse($request->created_at)->timezone('America/Bogota')->format('d/m/Y H:i')); ?>

                        </td>

                        
                        <td class="px-6 py-4">
                            <?php if($request->users->isNotEmpty()): ?>
                                <?php echo e($request->users->pluck('name')->join(', ')); ?>
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-2">
                            <?php if(auth()->user()->hasRole('administrador')): ?>
                                ...
                                <button onclick="openModal(<?php echo e($request->id); ?>)"
...
function openModal(id) {
    ...
    const routeTemplate = "<?php echo e(route('factorings.assign', ['id' => ':id'])); ?>";
