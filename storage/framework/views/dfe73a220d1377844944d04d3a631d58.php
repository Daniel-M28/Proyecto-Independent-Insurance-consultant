...
<div class="mt-24 max-w-7xl mx-auto p-6 bg-zinc-900 text-gray-100 rounded-lg shadow">
            ...
            <tbody class="divide-y divide-zinc-700 text-sm">
                <?php $__empty_1 = true; $__currentLoopData = $quotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-zinc-700 divide-x divide-zinc-600">
                        ...
                        <td class="px-6 py-4"><?php echo e($quote->created_at->timezone('America/Bogota')->format('Y-m-d H:i')); ?></td>
                        <td class="px-6 py-4">
                            <?php if($quote->users->isNotEmpty()): ?>
                                <?php echo e($quote->users->first()->name); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('admin.personal-quotes.show', $quote->id)); ?>" class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded-md">View</a>

                               

                                <?php if(auth()->user()->hasRole('administrador')): ?>
                                    <button onclick="openModal(<?php echo e($quote->id); ?>)" class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded-md">Asiggn</button>
                                <?php endif; ?>
    ...
    <div class="mt-6 flex justify-center"><?php echo e($quotes->links()); ?></div>
    <div class="mt-6"><a href="<?php echo e(route('dashboard')); ?>" class="text-gray-400 hover:underline">← Back to dashboard</a></div>
</div>
...
function openModal(id) {
    ...
    form.action = "<?php echo e(url('admin/personal-quotes')); ?>/"+id+"/assign";
