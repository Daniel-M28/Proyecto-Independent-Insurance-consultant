...
<!-- Main Section -->
<main id="home" class="relative w-full h-screen bg-cover bg-center" style="background-image: url('<?php echo e(asset('imgs/main.jpg')); ?>');">
...
<section id="services" class="w-full bg-zinc-800 text-white py-12 px-4 md:px-8 text-center scroll-mt-20">
  ...
  <div class="bg-zinc-900 border border-gray-700 rounded-md overflow-hidden flex flex-col transform transition duration-300 ease-in-out hover:scale-105 hover:shadow-lg">
    ...
    <div class="p-6 flex-1 flex flex-col">
      <div class="mb-4">
        <a  href="<?php echo e(route('regulatorios_form')); ?>" class="bg-pink-600 text-white text-lg font-bold px-4 py-2 rounded transition duration-300 ease-in-out hover:bg-pink-500 hover:shadow-md cursor-pointer">
          Regulatory permits
        </a>
      </div>
      <p class="text-gray-300 text-sm flex-1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto_iic\resources\views/welcome.blade.php ENDPATH**/ ?>