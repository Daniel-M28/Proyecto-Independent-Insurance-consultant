...
<form 
    id="form-comercial" 
    action="<?php echo e(route('commercial.store')); ?>" 
    method="post" 
...
>
    ...
    <div>
        ...
        >
            ...
            <option value="dryvan" <?php echo e(old('type_of_load')=='dryvan' ? 'selected' : ''); ?>>Dryvan</option>
            <option value="reefer" <?php echo e(old('type_of_load')=='reefer' ? 'selected' : ''); ?>>Reefer</option>
            <option value="flatbed" <?php echo e(old('type_of_load')=='flatbed' ? 'selected' : ''); ?>>Flatbed</option>
            <option value="carhauler" <?php echo e(old('type_of_load')=='carhauler' ? 'selected' : ''); ?>>Car Hauler</option>
            <option value="towing" <?php echo e(old('type_of_load')=='towing' ? 'selected' : ''); ?>>Towing</option>
        </select>
    </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div>
        ...
        <textarea 
            ...
            oninput="this.setCustomValidity('')"
        ><?php echo e(old('comments')); ?></textarea>
    </div>
...
<form 
    id="form-personal" 
    action="<?php echo e(route('admin.personal-quotes.store')); ?>" 
    method="post" 
    enctype="multipart/form-data" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input 
                ...
                maxlength="30" 
                value="<?php echo e(old('vehicle_type')); ?>"
                class="w-full p-3 bg-zinc-800 border border-gray-600 rounded-md" 
                required
        ...
        <div>
            ...
            <input 
                ...
                placeholder="Sedan" 
                maxlength="30" 
                value="<?php echo e(old('body_class')); ?>"
                class="w-full p-3 bg-zinc-800 border border-gray-600 rounded-md" 
                required
