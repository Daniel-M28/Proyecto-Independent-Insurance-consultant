    ...
    <div class="w-full lg:w-1/2 bg-[#121212] p-8 lg:p-16">
      ...
      <form id="form-personal" action="#" method="post" enctype="multipart/form-data" class="space-y-6 hidden">
        ...
        <div>
          ...
          <input type="date" name="dob"  max="{{ date('Y-m-d') }}"  class="w-full p-3 bg-zinc-800 border border-gray-600 rounded-md text-gray-300" required>
        </div>
        ...
        <div>
          ...
          <input type="date" name="iss_date" max="{{ date('Y-m-d') }}" class="w-full p-3 bg-zinc-800 border border-gray-600 rounded-md text-gray-300" required>
        </div>
